      ...
      <section className="about" id="about">
        <div className="wrap about-grid">
          ...
          <div className="about-text">
            ...
            <p>«Нұрзат» бөбекжайы Келес ауданы Ұшқын ауылы Еңбекші  мекенінде орналасқан. Жас топтарының әрқайсысына бөлек киім ілу бөлмесі, ойын аймағы, ұйықтайтын бөлме мен санитарлық торап қарастырылған — топтар бір-бірінен толық оқшауланған.</p>
